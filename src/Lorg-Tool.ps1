chcp 65001 | Out-Null
Write-Output "欢迎使用Lorg-Tool,下载项目:Roblox-NoticeSystem/Roblox-RGYBot/Roblox-BusSystem"
...
elseif ( "Roblox-BusSystem" -eq $var6 ) {
    $uri = "https://gitee.com/api/v5/repos/ywk2022/Roblox-BusSystem/releases"
    $response = Invoke-RestMethod -Uri $uri -Method Get
    Write-Output "目前版本有:"
    Write-Output $response.tag_name
}
...
if ( -not ( "" -eq $var2 ) ) {
    ...
    elseif ( "Roblox-BusSystem" -eq $var6 ) {
        $m1 = "https://gitee.com/ywk2022/Roblox-BusSystem/releases/download/V" + "" + $var1 + "/BusSystem%20-%20"
        $m3 = $m1 + "" + $var1 + "" + $var4
        Start-BitsTransfer -Source $m3 -Destination $var2
    }
}
