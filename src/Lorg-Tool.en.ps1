chcp 65001 | Out-Null
Write-Output "Welcome to Lorg-Tool, download project: Roblox-NoticeSystem/Roblox-RGYBot/Roblox-BusSystem"
...
elseif ( "Roblox-BusSystem" -eq $var6 ) {
    $uri = "https://api.github.com/repos/Lorg-Love/Roblox-BusSystem/releases"
    $headers = @{
        "Authorization"        = "Bearer <Your_Token>"
        "X-GitHub-Api-Version" = "2022-11-28"
    }
...
if ( -not ( "" -eq $var2 ) ) {
    ...
    if ( "Roblox-BusSystem" -eq $var6 ) {
        $var3 = "https://github.com/Lorg-Love/Roblox-BusSystem/releases/download/V" + "" + $var1 + "/BusSystem.-."
        $var5 = $var3 + "" + $var1 + "" + $var4
        Start-BitsTransfer -Source $var5 -Destination $var2
    }
}
